                                    ...
                                    @foreach($RincianObjekPenerimaan as $key => $Rincian1)
                                        ...
                                        @foreach($OPDPenerimaan as $key => $SubPenerimaan1)
                                            ...
                                            <tr style="background: rgb(253, 251, 251); color: #000000;">
                                                ...
                                                <td class="bg-danger" style="width: 100px; text-align: right"> <a href="javascript: void(0);" data-toggle="modal" data-id="{{$SubPenerimaan1->id}}" class="text-white buatrinciansub">{{ number_format($SubPenerimaan1->nilai_paguopd, 0, '.', ',') }}</a></td>
                                                @else
                                                <td style="width: 100px; text-align: right"> <a href="javascript: void(0);" data-toggle="modal" data-id="{{$SubPenerimaan1->id}}" class=" buatrinciansub">{{ number_format($SubPenerimaan1->nilai_paguopd, 0, '.', ',') }}</a></td>
                                                @endif
                                    ...
                                    @foreach($RincianObjekPenerimaan as $key => $Rincian2)
                                        ...
                                        @foreach($OPDPenerimaan as $key => $SubPenerimaan2)
                                            ...
                                            <tr style="background: rgb(253, 251, 251); color: #000000;">
                                                ...
                                                <td class="bg-danger" style="width: 100px; text-align: right"> <a href="javascript: void(0);" data-toggle="modal" data-id="{{$SubPenerimaan2->id}}" class="text-white buatrinciansub">{{ number_format($SubPenerimaan2->nilai_paguopd, 0, '.', ',') }}</a></td>
                                                @else
                                                <td style="width: 100px; text-align: right"> <a href="javascript: void(0);" data-toggle="modal" data-id="{{$SubPenerimaan2->id}}" class=" buatrinciansub">{{ number_format($SubPenerimaan2->nilai_paguopd, 0, '.', ',') }}</a></td>
                                                @endif
                                    ...
                                    @foreach($RincianObjekPenerimaan as $key => $Rincian3)
                                        ...
                                        @foreach($OPDPenerimaan as $key => $SubPenerimaan3)
                                            ...
                                            <tr style="background: rgb(253, 251, 251); color: #000000;">
                                                ...
                                                <td class="bg-danger" style="width: 100px; text-align: right"> <a href="javascript: void(0);" data-toggle="modal" data-id="{{$SubPenerimaan3->id}}" class="text-white buatrinciansub">{{ number_format($SubPenerimaan3->nilai_paguopd, 0, '.', ',') }}</a></td>
                                                @else
                                                <td style="width: 100px; text-align: right"> <a href="javascript: void(0);" data-toggle="modal" data-id="{{$SubPenerimaan3->id}}" class=" buatrinciansub">{{ number_format($SubPenerimaan3->nilai_paguopd, 0, '.', ',') }}</a></td>
                                                @endif
