...
<head>
    ...
    <title>{{ config('app.name', 'SIBKU') }}</title>
                            ...
                            <div class="col-md-10 col-lg-10 col-xl-9 mx-auto">
                                <div class="card-sigin">
                                    <div class="mb-5 d-flex">
                                        <a href="index.html" class="header-logo"><img src="../assets/images/brand-logos/desktop-logo1.png"
                                            class="desktop-logo ht-40" alt="logo">
                                            <img src="../assets/images/brand-logos/desktop-white1.png"
