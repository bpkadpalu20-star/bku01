...
<div class="row">
    <div class="col-12">
        <div class="page-title-box">
            ...
            <h4 class="page-title">Laporan BKU Pengeluaran</h4>
        </div>
    </div>
</div>
<div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    <label for="simpleinput">Bulan SP2D</label>
...
<div class="pdfpengeluaran"></div>
<div class="excelpengeluaran"></div>
<script type="text/javascript">
$(document).ready(function() {
    $("#cari_id_opd").select2()
    $("#cari_id_bank").select2()
    $("#cari_bulan").select2()
});
    $(document).ready(function(){
        $(document).ready(function () {
            var tampilawal = '1';
            $.ajax({
                url: "{{ route('laporan.bkupengeluaran.index') }}" +'/' + tampilawal +'/tampilawal',
                type: "GET",
    ...
    $('body').on('click', '.caribaru', function (e) {
        ...
        var tampilawal = '1';
        $.ajax({
            url: "{{ route('laporan.bkupengeluaran.index') }}" +'/' + tampilawal +'/tampil',
            // url: "{{ route('laporan.bkupengeluaran.index') }}" +'/' +
            // cari_no_sp2d +
            // cari_no_penguji + cari_id_opd + cari_id_bank + cari_nilai_sp2d + cari_bulan +'/tampil',
            type: "GET",
            // data:{cari_no_sp2d:cari_no_sp2d,cari_bulan:cari_bulan},
